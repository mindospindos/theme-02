...
class Pricing extends React.Component {
  ...
  render() {
    ...
    const tilesClasses = classNames(
      'tiles-wrap has-bg-color illustration-section-05',
      pushLeft && 'push-left'
    );

    const sectionHeader = {
      title: 'Simple pricing',
      paragraph: 'Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum — velit esse cillum.'
    };
        ...
        <div className="container">
          <div className={innerClasses}>
            ...
            <div className={tilesClasses}>
                ...
                <div className="tiles-item-inner has-shadow">
                  <div className="pricing-item-content">
                    <div className="pricing-item-header mb-24">
                      <div className="pricing-item-title text-xs text-color-high fw-500 pb-4">
                        Premium
                      </div>
              ...
              <div className="tiles-item reveal-scale-down" data-reveal-delay="100">
                <div className="tiles-item-inner has-shadow">
                  <div className="pricing-item-content">
                    <div className="pricing-item-header mb-24">
                      <div className="pricing-item-title text-xs text-color-high fw-500 pb-4">
              ...
              <div className="tiles-item reveal-scale-down" data-reveal-delay="200">
                <div className="tiles-item-inner has-shadow">
                  <div className="pricing-item-content">
                    <div className="pricing-item-header mb-24">
                      <div className="pricing-item-title text-xs text-color-high fw-500 pb-4">
